...
def main() -> None:
    ...
    with Trix.from_env() as client:
        ...
        reinforced = client.relationships.reinforce(rel1.id, boost=0.1)  # Increase weight by 0.1
        ...
        weakened = client.relationships.weaken(rel2.id, amount=0.2)
        ...
        print("   Memories related to Python:")
        ...
        updated = client.relationships.update(
            rel3.id, weight=1.0, description="Primary framework relationship"
        )
